...
/* Include files */
#include "_coder_position_info.h"
...
const mxArray *emlrtMexFcnResolvedFunctionsInfo(void)
{
  ...
  emlrtAssign(&nameCaptureInfo, emlrtCreateStructMatrix(6, 1, 0, NULL));
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]C:/Documents/MATLAB/test_GUI_ccd/position.m"), "context", 0);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1419926200U), "fileTimeLo", 0);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 0);
  emlrtAddField(*info, b_emlrt_marshallOut(1369988286U), "mFileTimeLo", 0);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1363688680U), "fileTimeLo", 1);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m"),
                "resolved", 3);
  emlrtAddField(*info, b_emlrt_marshallOut(1286797196U), "fileTimeLo", 3);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1386398752U), "fileTimeLo", 4);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/div.p"), "resolved",
                5);
  emlrtAddField(*info, b_emlrt_marshallOut(1419926228U), "fileTimeLo", 5);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("position"));
...
/* End of code generation (_coder_position_info.c) */

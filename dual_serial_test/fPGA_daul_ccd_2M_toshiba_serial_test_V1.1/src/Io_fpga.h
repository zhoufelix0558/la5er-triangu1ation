...
#define CCD_ST      	    EMIF_CS5_START_ADDR+204
...
#define RUN_FR_CNT1      	    EMIF_CS5_START_ADDR+220
#define RUN_FR_CNT2      	    EMIF_CS5_START_ADDR+224

#define FIFO_CNT_RD    	        EMIF_CS5_START_ADDR+228
#define FIFO_CNT_WR   	        EMIF_CS5_START_ADDR+232
#define FIFO_RD_ST   	        EMIF_CS5_START_ADDR+236
#define ADC_CFG      	        EMIF_CS5_START_ADDR+60*4
#define SELECT_CCD      	        EMIF_CS5_START_ADDR+63*4

...
{
	//SETBIT(DEBUG_PORT->IIR,0x00000000 );
	//DEBUG_PORT->IIR = 0x000000001;
	//UART_init(DEBUG_PORT,115200);
	SETBIT(DEBUG_PORT->IER,0x00000001 );
	CLRBIT(DEBUG_PORT->IIR,0x000000C0);
	CLRBIT(DEBUG_PORT->IIR,0x00000001);
	//SETBIT(DEBUG_PORT->FCR,0x0000000F);
}
...
uint32_t   com2str(uint8_t *  out_txt)
{
	...
	return UART_rxByte(DEBUG_PORT, out_txt);
//	UART_txString(DEBUG_PORT, "\r\n");
}
#endif

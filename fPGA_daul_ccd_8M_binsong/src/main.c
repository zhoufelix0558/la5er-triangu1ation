...
float mylocation;
float ratio = 0.8;
int loop_num = 4;			//累加的次数，uint16_t的极限是4次及以下
uint16_t buffer_int_data[2532]  ;
float buffer_tmp[2532];
uint16_t MaxValue ;			//检测的光斑可能最大值
...
float kalman_p1 = 20.0;
float kalman_preData1 = 0.0;
float kalman_result1 = 0.0;

float kalman_p2 = 20.0;
float kalman_preData2 = 0.0;
float kalman_result2 = 0.0;

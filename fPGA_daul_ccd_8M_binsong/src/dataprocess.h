...
extern uint16_t bi_side_search_float(const float data[point_NUM], uint16_t point_notclear, uint16_t direction, float ratio, uint16_t step,uint16_t MaxValue);
extern uint16_t bi_side_search_withMaxValue(const uint16_t data[point_NUM], uint16_t point_notclear, uint16_t direction, float ratio, int16_t step,uint16_t MaxValue);
...
extern float zhixin_upward(const float float_data[point_NUM], uint16_t startpoint, uint16_t endpoint, float ratio,uint16_t MaxValue);
...
extern uint16_t point_nclear_return_maxValue(const uint16_t data[point_NUM], uint16_t  step, uint16_t *MaxValue);
